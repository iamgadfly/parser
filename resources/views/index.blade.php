...
<body id="page-top">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Курс доллара</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $course->price }}
                                            </div>
                                        </div>
                                        <div class="col-auto">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Время последненего обновления</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $time }}
                                            </div>
                                        </div>
                                        <div class="col-auto">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $time_next }}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-6 mb-4">
                            <div class="card bg-info text-white shadow">
                                <div class="card-body height"
                                    ...
                                    <a style="color: #fff; text-decoration:none" href="/update_product">Запустить
                                        обновление одного товара </a>
                                </div>
                            </div>
                        </div>
                        {{--  <div class="col-lg-6 mb-4">
    ...
    <footer class="sticky-footer bg-white">
        <div class="container my-auto">
            <div class="copyright text-center my-auto">
                <span>Bitmarket parser for SDEK 2023</span>
            </div>
        </div>
    </footer>
    <!-- End of Footer -->
    ...
    <script>
        const job = document.getElementById('add_job')
        job.addEventListener('click', function() {
            $.ajax({
                ...
                success: document.getElementById('add_job').textContent = 'Обновление успещно началось!'
            });
