...
class PriceDeliveryAction
{
    ...
    {
        return match (true) {
            $weight == 1 || $weight == 1.5 && $raw_price > 450 => self::getPriceSnopfansLogistic($delivery, $snopfan_course, $customs_comisson),
            $weight > 1.5 && $raw_price >= 450 => self::getPriceSnopfansLogistic($dollar_course, $raw_price, $delivery, $snopfan_course, $customs_comisson, $payment_comisson),
            ...
            $weight >= 1 && $raw_price <= 380 => self::getPriceOnexLogisticWithCustoms($dollar_course, $delivery, $customs_comisson, $payment_comisson),
            default => null,
        };
    }

    public static function getPriceSnopfansLogistic($delivery, $snopfan_course, $customs_comisson)
    {
    ...
    {
        return ($delivery + ($raw_price - 380)) * $dollar_course * $payment_comisson * $customs_comisson;
    }

    public static function getPriceOnexLogisticWithCustoms($dollar_course, $delivery, $payment_comisson, $customs_comisson)
    {
        return $delivery * $dollar_course * $payment_comisson * $customs_comisson;
    }
